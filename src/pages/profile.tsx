    ...
    <Wrapper>
      ...
      <Content>
        ...
        <section>
          ...
          <h3>IOSアプリ(歴半年)</h3>
          <ul>
            <li>Flutterを利用したIOSアプリの開発</li>
          </ul>
          <h3>マネジメント(歴1.5年)</h3>
          <ul>
            <li>エンジニアの採用・教育を1年</li>
            <li>6~7名規模の開発でエンジニアのマネジメント</li>
            <li>仕様書作成, WBS作成, 工数見積もり, issue管理, レビュー, 進捗管理等</li>
          </ul>
          <h3>開発実績</h3>
          <ul>
          ...
          <h3>プロダクト開発</h3>
          <ul>
            <li>建築DXの0→1フェーズの参画</li>
            <li>ヒアリングを元にした企画コンサル、要件定義、設計を担当</li>
          </ul>
          <h3>執筆した記事の一部</h3>
          <ul>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Google広告を用いた広告運用の設計や効果測定</li>
        ...
        <section>
          ...
          <p>
            ...
            <a
              data-fokus='cv-profile'
              className='link'
              href={process.env.NEXT_PUBLIC_CONTACT_LINK}
              target='_blank'
              rel='noopener noreferrer'
            >
